...
Usage:
  ...
  debugserver host:port --attach=&ltpid>
  debugserver /path/file --attach=&ltpid>
  debugserver host:port --attach=&ltprocess_name>
  debugserver /path/file --attach=&ltprocess_name>
